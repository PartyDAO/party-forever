export const collection_batch_buy_crowdfund59b3cb95 = {
  abiHash: '59b3cb95',
  abi: [
  {
    "inputs": [
  ...
  {
    "inputs": [],
    "name": "ContributionsSpentForFailedBuyError",
    "type": "error"
  },
  {
    "inputs": [
  ...
  },
  {
    ...
    "name": "InvalidMinTokensBoughtError",
    "type": "error"
  },
  {
    "inputs": [
  ...
  {
    "inputs": [],
    "name": "MismatchedCallArgLengthsError",
    "type": "error"
  },
  {
    "inputs": [],
  ...
  },
  {
    "inputs": [
      ...
      {
        "internalType": "uint256",
        "name": "minTotalEthUsed",
        "type": "uint256"
      }
    ],
    "name": "NotEnoughEthUsedError",
    "type": "error"
  },
  {
    "inputs": [
    ...
    "name": "NotEnoughTokensBoughtError",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "NothingBoughtError",
    "type": "error"
  },
  {
    "inputs": [],
    ...
    "inputs": [
      {
        ...
        "internalType": "struct CollectionBatchBuyCrowdfund.BatchBuyArgs",
        "name": "args",
        "type": "tuple"
      }
    ],
